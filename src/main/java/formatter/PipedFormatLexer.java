...
public class PipedFormatLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "DEC_INT", "HEX_INT", "BIN_INT", 
			"STRING_", "BOOL_OPERATOR", "ADD_SUB_OPERATOR", "MUL_DIV_OPERATOR", "BOOLEAN", 
			"VARIABLE_NAME", "RETURN_OPERATOR", "PIPE_OPERATOR", "ASSIGN_OPERATOR", 
			"END_STATEMENT", "ID", "NEWLINE", "SPACE", "COMMENT"
		};
	}
	...
	public PipedFormatLexer(CharStream input) {
		super(input);
